...
var hljs = (function () {
	...
	class HTMLRenderer {
		...
		*/
		...
		span(className, id) {
			this.buffer += `<span class="${className}" data-id="${id}">`;
		}
	}
	...
	const HLJS = function(hljs) {
		...
		*/
		function _highlight(languageName, codeToHighlight, ignoreIllegals, continuation) {
			...
			const emitter = new options.__emitter(options);window.$emitter = emitter;
