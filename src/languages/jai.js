...
function jai(hljs) {
	...
	const STDLIB = {
		...
		'built_in.stdLib.Android': [
			...
			'android_main',
			'my_android_handle_command',
			'my_android_handle_input',
		],
		'type.stdLib.Android': [
			'AAssetManager',
			'AAssetDir',
...
//BUG: struct members are listing as types or just vars.  Should be properies.  Might need a custom contains?
//FIXME: genStdLib might be doing the wrong thing with #type; if it's v: #type it's a var, but if it's c::#type then its a type.
