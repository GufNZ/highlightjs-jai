...
function jai(hljs) {
	...
	/* Begin generated content [Version: beta 0.2.020, built on 27 November 2025]: */
	const STDLIB = {
		...
		'variable.stdLib.Basic.programParam': [
			...
			'TEMP_ALLOCATOR_POISON_FREED_MEMORY',
		],
	...
	const CASTS = [
		{	// Option 1: cast[,modifier...](type)value
			...
			relevance: 5,
			begin: `\\b(?:cast|xx)(?:${skipWSAndCommentsREFn()},${skipWSAndCommentsREFn(0)}(?:trunc|no_check|force|FORCE)${skipWSAndCommentsREFn(0)})?\\(`,
			returnBegin: true,
			keywords,
			contains: [
